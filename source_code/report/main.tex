...
% Header and Footer
	...
	% \renewcommand{\sectionmark}[1]{\markright{SEC.\ \thechapter\ #1}{}}
	\renewcommand{\chaptermark}[1]{\markboth{CH.\ \thechapter\ #1}{}}
...
\mainmatter
	...
	\chapter{What is the big bang?} % subfigures
	...
	\chapter{Code samples} % coding
		\section{Some python code}
			\begin{listing}[H]
				\centering
				\begin{minted}[beameroverlays, linenos, autogobble]{python}
	...
	\chapter{Steam Tables} % multi-files
		% \setlength\LTleft{-0.5in}
		\input{assets/steam-table.tex}
	
	\chapter{Some graphs} % graphs
		\section{Basics}
			% \digraph[scale=0.5]{graph1}{%
			% 	main [shape=box];
			% 	main -> fn1;
			% 	fn1 -> child1;
			% 	fn1 -> child2;
